...
for session in sessions:
  ...
  desktop_folder_path = r'C:\Users\Rishi Mody\Documents\GitHub\Trial-Website\pdfs\Physics_HL' + '\\' + session + ' Examination Session'
  ...
  for i in range(len(pdf_files)):
      ...
      div_str+="\n"
      div_str = div_str.replace("PATH", "pdfs/Physics_HL" + '/' + session + " Examination Session/" + pdf_files[i])
  ...
  for path in split_paths:
      ...
      if "Spanish" in path:
        ...
        path = ""
      # elif "paper_1_HLHL_markscheme" in path or "paper_1__HLHL_markscheme" in path:
      #   DESCRIPTOR = "Paper 1 HL/HL Markscheme"
      #   path = path.replace("DESCRIPTOR", DESCRIPTOR)
      #   new_paths.append(path)
      # elif "paper_1_HLHL" in path or "paper_1__HLHL" in path:
      #   DESCRIPTOR = "Paper 1 HL/HL"
      #   path = path.replace("DESCRIPTOR", DESCRIPTOR)
      #   new_paths.append(path)
      # elif "paper_2_HLHL_markscheme" in path or "paper_2__HLHL_markscheme" in path:
      #   DESCRIPTOR = "Paper 2 HL/HL Markscheme"
      #   path = path.replace("DESCRIPTOR", DESCRIPTOR)
      #   new_paths.append(path)
      # elif "paper_2_HLHL" in path or "paper_2__HLHL" in path:
      #   DESCRIPTOR = "Paper 2 HL/HL"
      #   path = path.replace("DESCRIPTOR", DESCRIPTOR)
      #   new_paths.append(path)
      # elif "paper_1_TZ1_HLHL_markscheme" in path or "paper_1__TZ1_HLHL_markscheme" in path:
      #   DESCRIPTOR = "Paper 1 TZ1 HL/HL Markscheme"
      #   path = path.replace("DESCRIPTOR", DESCRIPTOR)
      #   new_paths.append(path)
      # elif "paper_1_TZ1_HLHL" in path or "paper_1__TZ1_HLHL" in path:
      #   DESCRIPTOR = "Paper 1 TZ1 HL/HL"
      #   path = path.replace("DESCRIPTOR", DESCRIPTOR)
      #   new_paths.append(path)
        ...
        path = path.replace("DESCRIPTOR", DESCRIPTOR)
        new_paths.append(path)
      elif "paper_2_TZ1_HL_markscheme" in path or "paper_2__TZ1_HL_markscheme" in path:
        DESCRIPTOR = "Paper 2 TZ1 HL Markscheme"
        path = path.replace("DESCRIPTOR", DESCRIPTOR)
        new_paths.append(path)
      elif "paper_2_TZ1_HL" in path or "paper_2__TZ1_HL" in path:
        DESCRIPTOR = "Paper 2 TZ1 HL"
        path = path.replace("DESCRIPTOR", DESCRIPTOR)
        new_paths.append(path)
      elif "paper_2_TZ2_HL_markscheme" in path or "paper_2__TZ2_HL_markscheme" in path:
        DESCRIPTOR = "Paper 2 TZ2 HL Markscheme"
        path = path.replace("DESCRIPTOR", DESCRIPTOR)
        new_paths.append(path)
      elif "paper_2_TZ2_HL" in path or "paper_2__TZ2_HL" in path:
        DESCRIPTOR = "Paper 2 TZ2 HL"
        path = path.replace("DESCRIPTOR", DESCRIPTOR)
        new_paths.append(path)
      elif "paper_3_TZ1_HL_markscheme" in path or "paper_3__TZ1_HL_markscheme" in path:
        DESCRIPTOR = "Paper 3 TZ1 HL Markscheme"
        path = path.replace("DESCRIPTOR", DESCRIPTOR)
        new_paths.append(path)
      elif "paper_3_TZ1_HL" in path or "paper_3__TZ1_HL" in path:
        DESCRIPTOR = "Paper 3 TZ1 HL"
        path = path.replace("DESCRIPTOR", DESCRIPTOR)
        new_paths.append(path)
      elif "paper_3_TZ2_HL_markscheme" in path or "paper_3__TZ2_HL_markscheme" in path:
        DESCRIPTOR = "Paper 3 TZ2 HL Markscheme"
        path = path.replace("DESCRIPTOR", DESCRIPTOR)
        new_paths.append(path)
      elif "paper_3_TZ2_HL" in path or "paper_3__TZ2_HL" in path:
        DESCRIPTOR = "Paper 3 TZ2 HL"
        path = path.replace("DESCRIPTOR", DESCRIPTOR)
        new_paths.append(path)
