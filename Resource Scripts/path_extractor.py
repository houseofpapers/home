import os
sessions = ["2014 May", "2015 May", "2016 May", "2017 May", "2017 November", "2018 May", "2018 November", "2019 May", "2019 November", "2020 November", "2021 May", "2021 November", "2022 May", "2022 November"]
...
for session in sessions:
  ...
  desktop_folder_path = r'C:\Users\Rishi Mody\Documents\GitHub\Trial-Website\pdfs\Global_politics_HL' + '\\' + session + ' Examination Session'
  ...
  for i in range(len(pdf_files)):
      ...
      div_str+="\n"
      div_str = div_str.replace("PATH", "pdfs/Global_politics_HL" + '/' + session + " Examination Session/" + pdf_files[i])
